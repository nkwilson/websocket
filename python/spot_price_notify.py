...
def on_open(self):
    ...
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_1min'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_5min'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_15min'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_30min'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_1hour'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_2hour'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_4hour'}")    
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_6hour'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_12hour'}")
    self.send("{'event':'addChannel','channel':'ok_sub_spot_okb_btc_kline_day'}")
...
#    secret_key = "your secret_key which you apply"
    ...
    url = "wss://real.okex.com:10441/websocket/okexapi"
    api_key = 'ec85e40b-677d-419f-aff6-ee32b067c4e5'
    secret_key = 'B5FB21F4E45FEE30709FA7CF6CA9F330'
